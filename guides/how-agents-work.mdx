...
**AI Messages:** AIs send messages through the bridge, not through you. The `lesa_send_message` MCP tool routes messages to Lesa's OpenClaw gateway. She responds as herself.
