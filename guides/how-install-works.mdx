...
description: "How LDM OS installs tools, extensions, and configurations across all your AI harnesses."
---
...
2. Reads `~/.ldm/agents/<agent>/rules/` ... copies to `~/.claude/rules/` (agent-specific)
