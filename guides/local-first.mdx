...
description: "Every LDM OS tool must work fully on your machine without calling any external server."
---
...
The Crystal relay is a hosted MCP server that gives iOS and macOS Claude Code (cloud-hosted) access to Memory Crystal. It exists because Apple's platform doesn't allow local MCP servers on mobile.
