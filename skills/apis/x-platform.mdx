---
title: "X Platform"
description: "X Platform API. Read posts, search tweets, post updates, upload media. Built on the official xdk TypeScript SDK."
---
...
Four interfaces: CLI, Module, Connection Point, Skill.
...
Get credentials at [https://developer.x.com/en/portal/dashboard](https://developer.x.com/en/portal/dashboard)
